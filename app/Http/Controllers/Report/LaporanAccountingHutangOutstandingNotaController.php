...
class LaporanAccountingHutangOutstandingNotaController extends Controller {
  use AksesTrait;
  use GlobalTrait;
  ...
  public function index() {
    $akses = $this->cekAkses("reportaccountinghutangoutstandingnota");
    if ($akses['userLoggedOut']) { return redirect('/'); }

    if ($akses['akses']->Access) {
      return view('report.reportaccountinghutangoutstandingnota' , [
        "akses" => $akses
      ]);
    } else {

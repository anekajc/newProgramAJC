...
class LaporanAccountingBiayaPenyusutanController extends Controller {
  use AksesTrait;
  use GlobalTrait;

  public function index() {
    $akses = $this->cekAkses("laporanaccountingbiayapenyusutan");
    if ($akses['userLoggedOut']) { return redirect('/'); }

    if ($akses['akses']->Access) {
      return view('report.reportaccountingbiayapenyusutan' , [
        "akses" => $akses
      ]);
    } else {

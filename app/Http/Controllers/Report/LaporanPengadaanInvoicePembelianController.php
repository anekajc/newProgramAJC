...
class LaporanPengadaanInvoicePembelianController extends Controller {
  use AksesTrait;
  use GlobalTrait;

  public function index() {
    $akses = $this->cekAkses("laporanpengadaaninvoicepembelian");
    if ($akses['userLoggedOut']) { return redirect('/'); }

    if ($akses['akses']->Access) {
      return view('report.reportpengadaaninvoicepembelian' , [
        "akses" => $akses
      ]);
    } else {

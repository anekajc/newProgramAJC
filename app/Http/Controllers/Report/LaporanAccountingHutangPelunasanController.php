...
class LaporanAccountingHutangPelunasanController extends Controller {
  use AksesTrait;
  use GlobalTrait;
  ...
  public function index() {
    $akses = $this->cekAkses("reportaccountinghutangpelunasan");
    if ($akses['userLoggedOut']) { return redirect('/'); }

    if ($akses['akses']->Access) {
      return view('report.reportaccountinghutangpelunasan' , [
        "akses" => $akses
      ]);
    } else {

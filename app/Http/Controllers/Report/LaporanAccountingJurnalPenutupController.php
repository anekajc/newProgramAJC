...
class LaporanAccountingJurnalPenutupController extends Controller {
  use AksesTrait;
  use GlobalTrait;
  ...
  public function index() {
    $akses = $this->cekAkses("laporanaccountingjurnalpenutup");
    if ($akses['userLoggedOut']) { return redirect('/'); }

    if ($akses['akses']->Access) {
      return view('report.reportaccountingjurnalpenutup' , [
        "akses" => $akses
      ]);
    } else {

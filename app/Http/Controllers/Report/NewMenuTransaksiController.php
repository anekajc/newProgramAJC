...
class NewMenuTransaksiController extends Controller
{
  ...
  public function getMenuL0 () {
    ...
    // $menul0 = NewMenu::where([['HeaderMenu','=', 3],['L0','=', 0]])->orderBy('KODEMENU')->get();
    // $menul1 = NewMenu::where([['HeaderMenu','=', 3],['L0','=',1]])->orderBy('KODEMENU')->get();

    $menul0 = NewMenu::where('L0' , 0)->join('DBFLMENU', 'DBFLMENU.L1' ,'=' , 'DBMENU.KODEMENU')->where('DBFLMENU.USERID' , \Auth::user()->username)->where('DBFLMENU.HASACCESS' , 1)->where('DBMENU.HeaderMenu' , 4)->orderBy('KODEMENU')->get();
    $menul1 = NewMenu::where('L0' , 1)->join('DBFLMENU', 'DBFLMENU.L1' ,'=' , 'DBMENU.KODEMENU')->where('DBFLMENU.USERID' , \Auth::user()->username)->where('DBFLMENU.HASACCESS' , 1)->where('DBMENU.HeaderMenu' , 4)->orderBy('KODEMENU')->get();

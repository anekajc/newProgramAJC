...
class GudangPenyerahanSampleController extends Controller
{
  public function index(Request $req) {
    ...
    return view('gudang.gudangpenyerahansample', [
        "menul0" => $menul0,
        "periode" => $periode,
...
//   }
  ...
  public function spOtorisasi (Request $req) {
    ...
    $tempX2 =  app('App\Http\Controllers\GlobalController')->LoggingData( 'oto','SSP',$req->nobukti,'',0,'DBSERAHSAMPLE');
  ...
  public function spBatalOtorisasi (Request $req) {
    ...
    $res = DB::connection('SML')->update("update DBSERAHSAMPLE set isOtorisasi1 = 0, maxol = -1 , OtoUser1= '' , TglOto1 = NULL where nobukti = :nobukti", [ "nobukti" => $req->nobukti]);
     $tempX2 =  app('App\Http\Controllers\GlobalController')->LoggingData( 'btloto','SSP',$req->nobukti,$req->pket,0,'DBSERAHSAMPLE');
  ...
  public function spAdd(Request $req)
{
    ...
    $tempX2 =  app('App\Http\Controllers\GlobalController')->LoggingDataTrans('I','SSP',$req->nobukti,'',$d['URUT'],'DBSERAHSAMPLEDET');
    }
  ...
  public function spKoreksi(Request $req)
{
    ...
    if ($choice =='D'){
       $tempX2 =  app('App\Http\Controllers\GlobalController')->LoggingDataTrans($choice,'SSP',$req->nobukti,'',$req->urut,'DBSERAHSAMPLEDET');
      }

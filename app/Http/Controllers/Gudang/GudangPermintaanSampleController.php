...
class GudangPermintaanSampleController extends Controller
{
  ...
  public function loadAll()
{
  ...
  public function updateOtorisasi(Request $req) {
    ...
    $res = DB::connection('SML')->update(
     ...
     $tempX2 =  app('App\Http\Controllers\GlobalController')->LoggingData( 'oto','PRS',$req->nobukti,'',0,'DBPRSAMPLE');
    return $res;
}
  public function updateBatalOtorisasi(Request $req) {
    ...
    $tempX2 =  app('App\Http\Controllers\GlobalController')->LoggingData( 'btloto','PRs',$req->nobukti,$req->pket,0,'DBPRSAMPLE');
    return $res;
}
...
public function Gudang(Request $req)
{
  ...
  //   if ($req->ppn == 1) {
  //     $inisial = DB::connection("SML")->select('select PRS from DBNOMOR');
  ...
  //   } else {
  //     // $inisial = DB::connection("SML")->select('select PRSN from DBNOMOR');
  //   // $inisial = DB::connection("SML")->select('select SPR from DBNOMOR');
  //   // return [$periode->bulan,$inisial[0]->PBL,$username];
  //   $values = [
  //     'PRSN',
...
//  return ["asd" => $nobukti] ;
    ...
    if ($choice =='D'){
      $tempX2 =  app('App\Http\Controllers\GlobalController')->LoggingDataTrans( $req->choice,'PRS',$nobukti,'',$xurut,'DBPRSAMPLEdet');
      }
  ...
  public function spDelete(Request $req)
{
    ...
    $username = \Auth::user()->username;
     ...
     $tempX2 =  app('App\Http\Controllers\GlobalController')->LoggingDataTrans( $req->choice,'PRS',$nobukti,'',$req->urut,'DBPRSAMPLEdet');

      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="d-flex justify-content-end mb-2">
            <input id="input_search_barang_all" type="text" placeholder="Cari kode / nama barang" class="form-control" style="max-width: 260px;" onkeypress="searchBarangAll(event)">
          </div>
          <div class="container-fluid p-0" style="overflow:auto;">

...
<body>
        ...
        <nav class="sidebar-nav" id="nav">
            ...
            @foreach ($menul0 as $menu0)
                <div class="nav-group {{ $menu0['Keterangan'] === $activeMenuName ? 'active open' : '' }}">
                    <div class="nav-item"
                        onclick="{{ count($menu0['child']) > 0 ? 'toggleNavGroup(this)' : "window.location.href='" . $menu0->href . "'" }}">
                        <span class="nav-icon">
                            {!! [
                                'Berkas' =>
        ...
        <header class="header">
            <div class="header-left">
                ...
                <div class="breadcrumb" id="breadcrumb">
                    ...
                    <span class="bc-sep">›</span>
                    <b>@yield('breadcrumb_title', $autoPageTitle)</b>
                </div>
            </div>
 ...
 ============================================= -->
    ...
    <script type="text/javascript">
        ...
        // Sidebar accordion: open the clicked group and close whichever was open before.
        // Class-based (not id-based) so it stays correct however many groups render.

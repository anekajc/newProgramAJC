 ...
 ============================================= -->
  ...
  ============================================= -->
        <header id="header" class="full-header">
          ...
          ============================================= -->
                        <div id="logo">
                            <a class="navbar-brand" data-dark-logo="images/logo-dark.png">Gudang</a>
                        </div>
                        <!-- #logo end -->
      ...
      ============================================= -->
                        ...
                        <nav class="primary-menu" style="height:50px;">
                            <ul class="menu-container"
                                style="justify-content: left !important; align-items: left !important; height:50px;">

                                {{-- <li class="menu-item" style="height:50px;">
                      <a class="menu-link" href="setperiode"><div>{{ "SET PERIODE" }}</div></a>
                    </li> --}}
                                <li class="menu-item" style="display:flex;">
                                    <a class="" style="padding:15px; color:black;" href="#">
                                        <div>BERKAS</div>
                                    </a>
                                    <ul class="sub-menu-container">
                                        <li class="menu-item">
                                            <a class="menu-link" href="setperiode">
                                                <div>Set Periode</div>
                                            </a>
                                        </li>
                                    </ul>
                                ...
                                @foreach ($menul0 as $menu0)
                                    @if (count($menu0['child']) == 0)
                                        <li class="menu-item" style="height:50px;">
                                            <a class="menu-link" href="{{ url($menu0->href) }}">
                                                <div>{{ $menu0['Keterangan'] }}</div>
                                            </a>
                                        </li>
                                    @else
                                        <li class="menu-item" style="display:flex;">
                                            <a style="padding:15px; color:black;">
                                                <div>{{ $menu0['Keterangan'] }}</div>
                                            </a>
                                            <ul class="sub-menu-container">
                ...
                <ul>
                        ...
                        <div style="justify-content: end;">
                            <ul class="menu-container" style="height:50px;">
                                <a class="mt-1 ml-3" style="color: red;" href="{!! url('home') !!}">
                                    <div> </i>
                                        ↪
                                    </div>
                                </a>
        ...
        <header id="header" class="full-header" style="z-index: 1">
            ...
            <nav class="navbar navbar-expand-lg navbar-dark bg-primary" style="height: 25px;">
                ...
                <ul class="navbar-nav mr-auto">
                    <div id="div_periode" style="color: white">
                        Username : {!! \Auth::user()->username !!} - Periode : {!! $periode->bulan !!} /
                        {!! $periode->tahun !!}
                    </div>

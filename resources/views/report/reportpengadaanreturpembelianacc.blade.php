    ...
    <div class="tb-report main">
        <div class="content">
            ...
            <div class="toolbar">
               ...
               bukan dihapus: inputOrd genuinely dikonsumsi Sp_reportRBeliGDGDet. --}}
                ...
                <div class="action-group">
                    <button class="btn-load" type="button" data-bs-toggle="modal" data-bs-target="#modalFilter"
            ...
            <div class="table-outer">
                <div class="table-wrap">
                    <table class="tb" id="mainTable">
                        ...
                        <tbody id="tableBody">
                            <tr class="empty-row">
                                <td colspan="15">Atur filter lalu klik <b>Tampilkan</b> untuk memuat laporan.</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
            ...
            <div class="rt-hint">
                ...
                Seret judul kolom untuk mengurutkan. Klik <i class="bi bi-gear"></i> untuk sembunyikan kolom atau atur
                total.
            </div>
        ...
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    {{-- Report (Detail/Rekap) dibuang -- doReport() selalu memanggil
                   Sp_reportRBeliGDGDet yang sama (inputDetOrRekap tidak pernah dibaca server),
                   dan gcart_header untuk Detail & Rekap sudah identik di setDefaultHeader(),
                   jadi toggle ini tidak lagi mengubah apa pun. Dipatok Detail (0). --}}
...
@section('jsreport')
    <script type="text/javascript">
                ...
                views: {
                    ...
                    options: [{
                        ...
                        },
                        {
                            value: 'B',
                            label: 'Barang',
                            desc: 'Dikelompokkan per Nama Barang'
                        },
                        {
                            value: 'S',
                            label: 'Supplier',
                            desc: 'Dikelompokkan per Nama Supplier'
                        }
                    ],
                    get: function() {
        ...
        // Tiga slot per Order By (No Bukti/Barang/Supplier) -- kolomnya 100% identik (order hanya
        // mengubah urutan/grouping data dari proc), tapi tetap dipisah per mode supaya kustomisasi
        // kolom user (doSetHeader()/DBSIMPANHEADER) tidak bentrok antar Order By.

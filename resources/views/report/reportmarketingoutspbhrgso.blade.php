...
<div class="tb-report main">
  <div class="content">
    ...
    <div class="toolbar">
      {{-- <div>
        <div class="page-title">Report Marketing - Outstanding SPB Harga SO</div>
      </div> --}}
      ...
      <div class="modal-body">
        ...
        <div class="rt-section">
          ...
          {{-- Report (Detail/Rekap) TIDAK ada di sini: sudah jadi switcher "Tampilan" di bar atas
               ...
               tidak ada dropdown untuk ini di versi lama halaman ini). --}}
          <div class="rt-grid-1">
            <div>
              ...
              {{-- Param ke-6 Sp_ReportOutSpbDet (dulu di-hardcode 1, tidak ada kontrolnya sama
                   ...
                   2 = Semua. Sama seperti reportmarketingoutsppb.blade.php (proc yang sama),
                   belum diverifikasi langsung ke definisi SP. --}}
...
<script type="text/javascript">
  ...
  const reportUrl = "{{ url('laporanmarketingoutspbhrgso_doReport') }}";
  ...
  function exportDelimited(fmt) {
    ...
    a.download = 'OutstandingSPBHrgSO_' + (globalDate1 || '') + '_' + (globalDate2 || '') + '.' + ext;
  ...
  // Hanya dua mode: Detail dan Rekap. Tidak ada Order By di halaman ini -- controller selalu
  // memanggil proc dengan Ordr = "X" (nilai tetap), jadi currentGroupby juga tetap 'NoBukti'.

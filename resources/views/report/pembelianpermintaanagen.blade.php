...
<div class="container-fluid">
  ...
  <div class="row">
    <div class="col-6 text-left">
      <h1>Permintaan Pembelian Agen</h1>
    </div>
    <div class="col-6 text-right">
      <button type="button" class="btn btn-primary btn-lg " style="height: 60px; " onclick="buttonAdd()"  >Add Pembelian</button>
    </div>
  </div>
  ...
  <div class="modal-dialog modal-xl modal-dialog-centered"  role="document" >
      ...
      <div class="modal-body">
        ...
        <div class="container-fluid">
          <div class="row">
            ...
            <div class="col-4">
              <div class="form-group">
                <input type="date" class="form-control text-center" id="input_add_tanggal" value="{!! date('Y-m-d') !!}" placeholder="No Urut" >
              </div>
            </div>
          ...
          <div class="row">
            ...
            <div class="col-4">
              <select id="input_add_kodedepartemen" class="form-control" aria-label="Default select example">
    ...
    <div id="addAddItem" class="container-fluid showhide">
            ...
            <div class="row">
              ...
              <div class="col-3">
                <input id="input_add_add_refso" type="text" class="form-control" value="-" disabled>
              </div>
              ...
              <div class="col-4">
                ...
                <input id="input_add_add_nopocust" type="text" class="form-control" disabled>
              </div>
            ...
            <div class="row">
              ...
              <div class="col-1 text-right">
                ...
                <button type="button" onclick="buttonAddListKodeBarang()" class="btn btn-primary" >+</button>
              </div>
            </div>
            <div class="row">
              <div class="col-2">
              ...
              <div class="col-4">
                <input id="input_add_add_keterangannama" type="text" class="form-control" disabled>
              </div>
      ...
      <div class="modal-body">
        ...
        <div class="container-fluid">
          <div class="row">
            ...
            <div class="col-4">
              <div class="form-group">
                <input type="text" class="form-control" id="input_detail_nourut" placeholder="No Urut" disabled>
              </div>
            </div> -->

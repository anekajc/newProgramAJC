...
<script type="text/javascript">
  ...
  function setDefaultHeader() {
    if (g_modeReport == modereport_nobukti) {
      gcart_header = [
        ...
        ['sisa', 'Qnt Sisa', 1, 'float', 1, 0],
        ['QNTSS', 'RSS+BBS', 1, 'float', 1, 0],
        ['SS', 'PMS-RSS-BBS', 1, 'float', 1, 0],
  ...
  function makeTable(_mode) {
    ...
    doMakeTable(_mode, groupby, data, "REPORT OUTSTANDING PERMINTAAN SAMPLE", _date1, _date2);
  }

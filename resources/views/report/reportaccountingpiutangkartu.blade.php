...
{{-- Table styling lives in public/css/report-table.css (loaded via report/newmaster2.blade.php).
     ...
     dengan subtotal per pelanggan + grand total (toggle Customize Table). Mode IDR / $ (valas).
     Pelanggan Awal/Akhir & Valas tetap pakai modal (data banyak); Perkiraan pakai dropdown.
     Klik No Nota / No Bukti membuka voucher (report-table.js). --}}
<style>
    #inputReportMode,
    #inputOrder,
    #inputPerkiraanBtn {
            ...
            <div class="toolbar">
                ...
                <div class="filter-wrap">
                    ...
                    <button type="button" class="btn-pick" onclick="buttonSelectSuppAwal()"
                        title="Pilih Pelanggan Awal">+</button>
                </div>
                ...
                <div class="filter-wrap">
                    ...
                    <button type="button" class="btn-pick" onclick="buttonSelectSuppAkhir()"
                        title="Pilih Pelanggan Akhir">+</button>
                </div>

  ...
  <div class="d-flex align-items-center" style="gap:10px;">
    ...
    <div class="dropdown">
      ...
      <div class="dropdown-menu p-3" style="min-width:250px;">
        <label for="inputTipe" class="mb-1">Jenis</label>
        <select id="inputTipe"
                class="form-control">
...
<script type="text/javascript">
  ...
  function makeTable(_mode) {
    ...
    let data = {
      ...
      inputTipe        : $("#inputTipe").val(),
    };

    doMakeTable(_mode, groupby, data, "REPORT " + $('#inputTipe option:selected').text().toUpperCase(), _date1);
  }

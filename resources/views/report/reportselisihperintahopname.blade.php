...
<script type="text/javascript">
  ...
  function setDefaultHeader() {
    if (g_modeReport == modereport_nobukti) {
      gcart_header = [
        ...
        ['KodeHdGrp', 'Group', 1, 'varchar', 0, 0],
        ['KodeGdg', 'Gdg', 1, 'varchar', 0, 0],
        ['Satuan', 'Sat', 1, 'varchar', 0, 0],
        ['QNTOP', 'Qnt', 1, 'float', 0, 0],
        ['OPNAME', 'OPN', 1, 'float', 0, 0],
        ['SELISIH', 'Slsh', 1, 'float', 0, 0],
        ['hpp', 'HPP', 1, 'float', 0, 0],
      ...
      gcart_header = [
        ...
        ['KodeGdg', 'Gdg', 1, 'varchar', 0, 0],
        ['Satuan', 'Sat', 1, 'varchar', 0, 0],
        ['QNTOP', 'Qnt', 1, 'float', 1, 0],
        ['OPNAME', 'OPN', 1, 'float', 1, 0],
        ['SELISIH', 'Slsh', 1, 'float', 1, 0]
      ];
  ...
  function makeTable(_mode) {
    ...
    doMakeTable(_mode, groupby, data, "REPORT SELISIH PERINTAH TRANSFER", _date1, _date2);
  }

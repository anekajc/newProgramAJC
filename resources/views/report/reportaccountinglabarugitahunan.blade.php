...
<script type="text/javascript">
  ...
  function setDefaultHeader() {
    if (g_modeReport == modereport_detailnobukti) {
      gcart_header = [
        ['keterangan', 'Keterangan', 1, 'varchar', 0, 0, [1, 1, 2], false],
        ['', 'Januari', 1, 'group', 0, 0, [1, 2, 1], true], // header only
        ['bln1', 'Rp.', 1, 'float', 1, 2, [2, 1, 1], false], 
        ['P1', '%', 1, 'float', 1, 2, [2, 1, 1], false], 

        ['', 'Februari', 1, 'group', 0, 0, [1, 2, 1], true], // header only
        ['bln2', 'Rp.', 1, 'float', 1, 2, [2, 1, 1], false], 
        ['P2', '%', 1, 'float', 1, 2, [2, 1, 1], false], 

        ['', 'Maret', 1, 'group', 0, 0, [1, 2, 1], true], // header only
        ['bln3', 'Rp.', 1, 'float', 1, 2, [2, 1, 1], false], 
        ['P3', '%', 1, 'float', 1, 2, [2, 1, 1], false],

        ['', 'April', 1, 'group', 0, 0, [1, 2, 1], true], // header only
        ['bln4', 'Rp.', 1, 'float', 1, 2, [2, 1, 1], false], 
        ['P4', '%', 1, 'float', 1, 2, [2, 1, 1], false],

        ['', 'Mei', 1, 'group', 0, 0, [1, 2, 1], true], // header only
        ['bln5', 'Rp.', 1, 'float', 1, 2, [2, 1, 1], false], 
        ['P5', '%', 1, 'float', 1, 2, [2, 1, 1], false],

        ['', 'Juni', 1, 'group', 0, 0, [1, 2, 1], true], // header only
        ['bln6', 'Rp.', 1, 'float', 1, 2, [2, 1, 1], false], 
        ['P6', '%', 1, 'float', 1, 2, [2, 1, 1], false],

        ['', 'Juli', 1, 'group', 0, 0, [1, 2, 1], true], // header only
        ['bln7', 'Rp.', 1, 'float', 1, 2, [2, 1, 1], false], 
        ['P7', '%', 1, 'float', 1, 2, [2, 1, 1], false],

        ['', 'Agustus', 1, 'group', 0, 0, [1, 2, 1], true], // header only
        ['bln8', 'Rp.', 1, 'float', 1, 2, [2, 1, 1], false], 
        ['P8', '%', 1, 'float', 1, 2, [2, 1, 1], false],

        ['', 'September', 1, 'group', 0, 0, [1, 2, 1], true], // header only
        ['bln9', 'Rp.', 1, 'float', 1, 2, [2, 1, 1], false], 
        ['P9', '%', 1, 'float', 1, 2, [2, 1, 1], false],

        ['', 'Oktober', 1, 'group', 0, 0, [1, 2, 1], true], // header only
        ['bln10', 'Rp.', 1, 'float', 1, 2, [2, 1, 1], false], 
        ['P10', '%', 1, 'float', 1, 2, [2, 1, 1], false],

        ['', 'November', 1, 'group', 0, 0, [1, 2, 1], true], // header only
        ['bln11', 'Rp.', 1, 'float', 1, 2, [2, 1, 1], false], 
        ['P11', '%', 1, 'float', 1, 2, [2, 1, 1], false],

        ['', 'Desember', 1, 'group', 0, 0, [1, 2, 1], true], // header only
        ['bln12', 'Rp.', 1, 'float', 1, 2, [2, 1, 1], false], 
        ['P12', '%', 1, 'float', 1, 2, [2, 1, 1], false],

        ['', 'Total', 1, 'group', 0, 0, [1, 2, 1], true], // header only
        ['bln', 'Rp.', 1, 'float', 1, 2, [2, 1, 1], false], 
        ['P13', '%', 1, 'float', 1, 2, [2, 1, 1], false],
      ];
  ...
  function makeTable (_mode) {
    ...
    doMakeTable(_mode, groupby, data, "REPORT LABA RUGI TAHUNAN", _date1);
  }

...
@include('report.modalMarketingInvoice')
    ...
    <div class="d-flex" style="gap: 10px;">
      ...
      <div class="dropdown">
        ...
        <ul class="dropdown-menu" id="dropdownOrder" aria-labelledby="inputOrder" style="max-height: 125px; overflow-y: auto;">
          ...
          <li><a class="dropdown-item" style="cursor: pointer;" data-value="S" onclick="setOrderBy('S')">Sales</a></li>
          <li><a class="dropdown-item" style="cursor: pointer;" data-value="HM" onclick="setOrderBy('HM')">Merk</a></li>
        </ul>
      </div>
      ...
      <div class="dropdown">
        ...
        <ul class="dropdown-menu" id="dropdownOrder" aria-labelledby="inputDataPilih" style="min-width: 600px; padding: 10px;">
          <li onclick="event.stopPropagation();">
            ...
            <div class="row text-center" style='margin-top:5px;'>
              <div class="col-2">
                <label for="inputlokasi">Jenis</label>
              </div>
              <div class="col-4 input-group">
                <input type="text" class="form-control" id="inputJenis" placeholder="Jenis" value='-'>
                  <div class="input-group-append">
                      <button type="button" class="btn btn-primary btn-select" style='height:31px;' onclick="buttonSelect('selectJenis')">+</button>
                  </div>
              </div>
              <div class="col-2">
                <label for="inputlokasi">Group</label>
              ...
              <div class="col-4 input-group">
                <input type="text" class="form-control" id="inputGroup2" placeholder="Group" value='-'>
                  <div class="input-group-append">
                      <button type="button" class="btn btn-primary btn-select" style='height:31px;' onclick="buttonSelect('selectGroup2')">+</button>
                  </div>
              </div>
            </div>
...
<script type="text/javascript">
  ...
  function setDefaultHeader() {
    if (g_modeReport == modereport_detailnobukti) {
      gcart_header = [
        ...
        ['tglSPB', 'Tanggal', 1, 'date', 0, 0],
        ['NoSPB', 'Nomor SPB', 1, 'varchar', 0, 0],
        ['NAMACUSTSUPP', 'Nama Customer', 1, 'varchar', 0, 0],
        ['NAMABRG', 'Nama Barang', 1, 'varchar', 0, 0],
        ['qnt', 'Qnt', 1, 'float', 0, 0],
        ['DiscP', 'Harga', 1, 'float', 0, 0],
        ['NDPP', 'DPP VLS', 1, 'float', 1, 0],
        ['NDPPRp', 'Nilai DPP', 1, 'float', 1, 0],
      ...
      gcart_header = [
        ...
        ['NoSPB', 'Nomor SPB', 1, 'varchar', 0, 0],
        ['NAMACUSTSUPP', 'Nama Customer', 1, 'varchar', 0, 0],
        ['NAMACUSTSUPP', 'PO Customer', 1, 'varchar', 0, 0],
        ['NAMABRG', 'Nama Barang', 1, 'varchar', 0, 0],
        ['qnt', 'Qnt', 1, 'float', 1, 0],
        ['HARGA', 'Harga', 1, 'float', 1, 2],
        ['DISCTOT', 'Disc', 1, 'float', 1, 2],
        ['NDPP', 'DPP VLS', 1, 'float', 1, 2],
        ['NDPPRp', 'Nilai DPP', 1, 'float', 1, 2]
      ];
      gsum_issubtotal = 1; gsum_isgrandtotal = 1;
  ...
  function makeTable(_mode) {
    ...
    let input_order = globalOrderBy;
      ...
      console.log(globalOrderBy, input_order)
      console.log(inputOto, _inputAgen, _inputCustomer, _inputGroup, _inputPIC, _inputKategori, _inputSubKategori, _inputMerk, input_order)
   ...
   setDefaultHeader();
    ...
    doMakeTable(_mode, groupby, data, "REPORT MARKETING INVOICE", _date1, _date2, _inputAgen, _inputCustomer, _inputGroup, _inputPIC, _inputKategori, _inputSubKategori, _inputMerk);
  }

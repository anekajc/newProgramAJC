        ...
        <table id="sourceTable" class="table table-bordered table-striped">
          ...
          <tbody id="tabel_dataAddGroupAktiva" class="text-left">
            ...
            <td style="border: 1px solid black;" class="text-center">
              <input type="checkbox" id="vehicle3" name="vehicle3" value="0"> </td>
                      </td>
...
const _header = [
  [{ 'colName': 'NoBukti' }, { 'headName': 'No Bukti' }, { 'isTampil': false }],
  [{ 'colName': 'Tanggal' }, { 'headName': 'Tanggal' }, { 'isTampil': true }],
  [{ 'colName': 'KodeCustSupp' }, { 'headName': 'Customer' }, { 'isTampil': true }],
  [{ 'colName': 'NAMACUSTSUPP' }, { 'headName': 'Nama Customer' }, { 'isTampil': true }],
  [{ 'colName': 'Urut' }, { 'headName': 'Total' }, { 'isTampil': true }],
  [{ 'colName': 'KodeBrg' }, { 'headName': 'Kode Barang' }, { 'isTampil': true }],
  [{ 'colName': 'NamaBrg' }, { 'headName': 'Nama Barang' }, { 'isTampil': true }],
  [{ 'colName': 'Qnt' }, { 'headName': 'Qnt' }, { 'isTampil': true }],
  [{ 'colName': 'NoSat' }, { 'headName': 'No Satuan' }, { 'isTampil': true }],
  [{ 'colName': 'Isi' }, { 'headName': 'Isi' }, { 'isTampil': true }],
  [{ 'colName': 'Satuan' }, { 'headName': 'Satuan' }, { 'isTampil': true }],
  [{ 'colName': 'Keterangan' }, { 'headName': 'Keterangan' }, { 'isTampil': true }],
  [{ 'colName': 'NeedOtorisasi' }, { 'headName': 'Otorisasi' }, { 'isTampil': true }],
  [{ 'colName': 'Qntbatal' }, { 'headName': 'Qnt Batal' }, { 'isTampil': true }],
  [{ 'colName': 'Tglbatal' }, { 'headName': 'Tgl Batal' }, { 'isTampil': true }],
  [{ 'colName': 'UserBatal' }, { 'headName': 'User Batal' }, { 'isTampil': true }],
  [{ 'colName': 'PartNumber' }, { 'headName': 'Part Number' }, { 'isTampil': true }],
];

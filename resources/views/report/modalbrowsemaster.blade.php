          ...
          <div class="modal-dialog modal-sm modal-dialog-centered"  role="document" style="max-width: 50%">
            <div class="modal-content">
              <div class="modal-header text-right">
                ...
                <button type="button" class="close" data-dismiss="modal" aria-label="Close" onclick="doCloseFormBrowseMaster()">
                ...
                <div class="container-fluid">
                  <div class="row mt-3 mb-2" id="tabelbrowsefilter" style="display: none;">
                    <div class="col-12 d-flex justify-content-end align-items-center">
                      <label for="browsefilter" class="mr-2 mb-0">Filter:</label>
                      ...
                      <button type="button" class="btn btn-primary col-1" style="font-size: 14px; margin: 0 5px;" onclick="doBrowseMasterFilter()"><i class="bi bi-search"></i></button>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-12" style="overflow:auto;">
                      <div class="">
                            <table id="tabelbrowsemaster" class="table table-bordered table-striped"  >
                              <thead id="tabelbrowsemaster_header" class="text-center">
                              </thead>
                              <tbody id="tabelbrowsemaster_data" class="text-center" >
                              </tbody>
                            </table>
                      </div>
                    </div>
              ...
              <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal" onclick="doCloseFormBrowseMaster()" title="Batal (Esc)">Batal</button>

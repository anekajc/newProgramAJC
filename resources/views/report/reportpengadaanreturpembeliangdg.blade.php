...
@section('header2')
  <div class="tb-report main">
      <div class="content">
        ...
        <div class="toolbar">
          <div>
            <div class="page-title">Retur Pembelian GDG</div>
...
<script type="text/javascript">
  ...
  function renderRows(rows, groupby) {
    ...
    let html = '', prev = null, sub = { qnt: 0, Qnt2: 0 }, grand = { qnt: 0, Qnt2: 0 };

    rows.forEach(function (r, i) {
      const now = r[groupby];

      // subtotal saat nilai grup berganti (kalau toggle Subtotal aktif)
      if (showSub && i !== 0 && prev !== now) { html += totalRowTotal('Subtotal', sub, cols, 'subtotal-row'); sub = {  qnt: 0, Qnt2: 0 };
      }

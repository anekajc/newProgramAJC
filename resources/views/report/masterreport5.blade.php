...
<script type="text/javascript">
  ...
  function doLoadHeader(_href, _mode) {
    console.log('set1');
    let _header = "";
    console.log(_href, _mode);

    // TAMBAHAN UNTUK MODE VARCHAR
    if (Number(_mode) || _mode == 0) {
        ...
        _tempcart.forEach((itemcart, j) => {
          if (itemcart[2] === 1) {
            ...
            if (itemcart[4] === 1) {
              ...
              if (itemcart[3] === "float") {
                rowTable +=
                  '  <td class="st' + _counter + ' cellcompact-right" ' +

...
<div class="tb-report main">
  <div class="content">
    ...
    <div class="toolbar">
      {{-- <div>
        <div class="page-title">Report Marketing - Retur Penjualan</div>
      </div> --}}
      ...
      <div class="modal-body">
        ...
        <div class="rt-section">
          ...
          {{-- Tidak ada switcher "Tampilan": Report Mode (Detail/Rekap) dan varian Order By
               (Nomor Barang/Nomor Customer) sebelumnya mengganti gcart_header ke boilerplate
               generik (NetW/GrossW, NDPP/NPPN/TotalIDR/Vls/Kurs/...usd) yang sama seperti
...
<script type="text/javascript">
  ...
  // Nilai netral Otorisasi adalah "2" (Semua) sesuai label dropdown, TAPI default halaman ini
  // sejak awal adalah "0" (Non Otorisasi) -- dipertahankan apa adanya, bukan diubah ke "2".
  let globalOtorisasi = "0"; // default: Non Otorisasi
  ...
  function exportDelimited(fmt) {
    ...
    a.download = 'ReturPenjualan_' + (globalDate1 || '') + '_' + (globalDate2 || '') + '.' + ext;
  ...
  // Kolom dari mode Detail + Nomor Bukti (satu-satunya yang dipertahankan). QNT dulu berlabel
  // "Harga" (duplikat dengan kolom HARGA) -- dikoreksi jadi "Qty".

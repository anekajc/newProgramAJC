...
{{-- Table styling lives in public/css/report-table.css (loaded via report/newmaster2.blade.php).
     .checkmark-red is also defined there. Only the two toolbar dropdown-toggle buttons and the
...
<style>
  ...
  #kasSummary td { padding: 9px 14px; border-bottom: 1px solid #F1F5F9 !important; }
</style>
...
<div class="tb-report main">
  <div class="content">
    ...
    <div class="toolbar">
      ...
      <!-- Perkiraan (dropdown; diisi dari reportaccountingkasharian_loadperkiraan) -->
      <div class="filter-wrap">
...
<script type="text/javascript">
  ...
  $(document).ready(function () {
    ...
    // Valas = rekap); tetap sinkron dengan dropdown Mode di toolbar karena
    // keduanya lewat setReportMode().
    ReportTable.init({
      table: '#mainTable',
      bar: '#rtBar',
      onChange: function () {

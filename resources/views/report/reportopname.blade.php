...
@section('header2')
    <div class="tb-report main">
        <div class="content">
            ...
            <div class="toolbar">
                {{-- <div>
                    <div class="page-title">Opname</div>
                </div> --}}
...
@section('jsreport')
    <script type="text/javascript">
        ...
        const reportUrl = "{{ url('laporanopname_doReport') }}";
        ...
        // otorisasi / order by: filter yang dikirim ke SP, dibaca langsung oleh makeTable()
        ...
        function exportDelimited(fmt) {
            ...
            a.download = 'Opname_' + (globalDate1 || '') + '_' + (globalDate2 || '') + '.' + ext;
        ...
        function makeTable(_mode) {
            ...
            $.ajax({
                ...
                error: function(xhr) {
                    console.error('laporanopname_doReport gagal:', xhr.status, xhr.responseText);

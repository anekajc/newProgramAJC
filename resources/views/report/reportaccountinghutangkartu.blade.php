...
{{-- Table styling lives in public/css/report-table.css (loaded via report/newmaster2.blade.php).
     ...
     dengan subtotal per supplier + grand total (toggle Customize Table). Mode IDR / $ (valas).
     Supplier Awal/Akhir & Valas tetap pakai modal (data banyak); Perkiraan pakai dropdown. --}}
<style>
    #inputReportMode,
    #inputOrder,
    #inputPerkiraanBtn {

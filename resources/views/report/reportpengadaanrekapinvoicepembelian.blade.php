...
@section('header2')
  <div class="tb-report main">
      <div class="content">
        {{-- <div class="page-title" style="margin-bottom:8px;">Rekap Invoice Pembelian</div> --}}
        ...
        <div class="toolbar">
          ...
          {{-- Tidak ada Order By di halaman ini: controller doReport() men-hardcode Ordr="G"
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="rt-section">
            ...
            <div class="rt-grid-1">
              {{-- "Report" (Detail/Rekap) DIHAPUS: dua cabang gcart_header di file lama 100%
                   identik (kolom sama persis) dan doReport() controller tidak pernah membaca
                   inputDetOrRekap -- toggle ini tidak mengubah apa pun sama sekali, di kedua
                   sisi (server maupun kolom tampilan). Sebagai gantinya, Otorisasi dihidupkan:
                   controller genuinely membaca inputOto (parameter ke-6 sp_reportinvoicedet),
                   tapi sebelumnya tidak ada UI ataupun payload untuk itu sama sekali. --}}
              <div class="mb-3">
...
<script type="text/javascript">
  ...
  // Subtotal/Grand Total = jumlah kolom DPP/PPN/Net, dikelompokkan per NoBukti.
  ...
  function totalRowTotal(label, total, cols, cls) {
    const totalKeys = ['NDPP', 'NPPN', 'NNET'];

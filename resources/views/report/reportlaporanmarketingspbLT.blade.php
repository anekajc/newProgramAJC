...
@section('jsreport')
    <script type="text/javascript">
        ...
        let globalOtorisasi = "0"; // default: sesuai urutan option lama (Otorisasi)
        let globalTerima = "0";    // default: sesuai urutan option lama (Tgl. Terima)
        // Sp_ReportSPBDet untuk laporan ini cuma dipakai dengan SATU urutan ("LT" = Lead Time /
        ...
        // otorisasi / tgl. terima: filter yang dikirim ke SP, dibaca langsung oleh makeTable()
        ...
        function exportDelimited(fmt) {
            ...
            a.download = 'LaporanSPBLeadTime_' + (globalDate1 || '') + '_' + (globalDate2 || '') + '.' + ext;
        ...
        function makeTable(_mode) {
            ...
            // Order By selalu "LT" (satu-satunya opsi) -> selalu grup per No Bukti
            let groupby = 'NOBUKTI';
            ...
            $.ajax({
                ...
                error: function(xhr) {
                    console.error('laporanmarketingspbLT_doReport gagal:', xhr.status, xhr.responseText);
        ...
        // sesuai urutan simpanan) -> mode-agnostic, jadi tiap mode report langsung terpakai

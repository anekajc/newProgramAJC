...
<script type="text/javascript">
  ...
  function setDefaultHeader() {
    if (g_modeReport == modereport_nobukti) {
      gcart_header = [
        ...
        ['Sales', 'Sales', 1, 'varchar', 0, 0],
        ['noPR', 'No. PR Sampel', 1, 'varchar', 0, 0],
        ['KODEBRG', 'Kode Barang', 1, 'varchar', 0, 0],
        ['NAMABRG', 'Nama Barang', 1, 'varchar', 0, 0],
        ['GDGASAL', 'Gd A', 1, 'varchar', 0, 0],
        ['GDGTUJUAN', 'Gd B', 1, 'varchar', 0, 0],
  ...
  function makeTable(_mode) {
    ...
    doMakeTable(_mode, groupby, data, "REPORT PENYERAHAN SAMPLE", _date1, _date2);
  }

...
<div class="modal fade" id="form" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-xl modal-dialo g-centered"  role="document">
    <div id="" class="modal-content ">
      ...
      <div id="" class="modal-footer ">
        ...
        <button type="button" class="btn btn-secondary btn-pill-secondary" onclick="buttonAddListBatal()">Batal</button>
      </div>
      </div>
  ...
  <div class="col-md-1" style="padding:0 ; margin:0; padding-left: 5px">
    <div class="form-group text-left">
      ...
      <div id="" class="modal-footer ">
        <button id="buttonAddNewAktiva" type="button" class="btn btn-chip-biru" onclick="buttonAddNewAktiva()">+ Aktiva baru</button>
        <button type="button" class="btn btn-secondary btn-pill-secondary" onclick="buttonAddListBatal()">Batal</button>
      </div>
      </div>
  ...
  <div class="col-md-1" style="padding:0 ; margin:0; padding-left: 5px">
    <div class="form-group text-left">
      ...
      <div class="modal-body">
        ...
        <div class="container-fluid mt-4" >
          ...
          <div class="row">
            ...
            <table id="tabel_add_list_dphuhtbbm_custsupp" class="dph-tb">
              <thead>
                <tr>
                  <th scope="col">KODE</th>
                  <th scope="col">Nama</th>
          ...
          <!-- </div> -->
            ...
            <div class="row">
              ...
              <table id="tabel_add_list_dphuhtbbm" class="dph-tb">
                <thead>
                  <tr>
      ...
      <div id="" class="modal-footer ">
        <button type="button" class="btn btn-secondary btn-pill-secondary" onclick="buttonAddListBatal()">Batal</button>
        <button type="button" class="btn btn-primary btn-action-primary btn-pill-primary" onclick="buttonAddPickInvoice()">Submit</button>
      </div>
      </div>

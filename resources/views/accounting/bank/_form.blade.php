...
<div class="container-fluid">
  ...
  <div class="col-md-12">
    ...
    Kembali Uang
      ...
      <div class="col-md-12  text-right">
      <button id="buttonAddAddItem" type="button" class="btn btn-chip-biru" onclick="buttonAddAddItem()">+ Tambah</button>
    </div>
    </div>
  </div>
...
<div class="row" style="margin-top: -10px">
  ...
  <div class="row mt-2" style="margin-top: 0" id="contentContainer">
    <div class="col-md-12 text-right mt-4">
      <button type="button" class="btn btn-secondary btn-pill-secondary" onclick="buttonAddBatal()">Batal</button>

      <button id="buttonSubmitAddAdd" type="button" onclick="submitAddAdd()" class="btn btn-primary btn-action-primary btn-pill-primary">Submit Add</button>

      <button id="buttonSubmitAddEdit" type="button" onclick="submitAddEdit()" class="btn btn-primary btn-action-primary btn-pill-primary">Submit Edit</button>

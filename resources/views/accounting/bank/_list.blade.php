...
<div id="contentContainer" class="container-fluid">
  ...
  {{-- .tb-report/.content dilepas (pindah ke skema po-*, lihat catatan di bank.blade.php
  ...
  <div class="card">
    <div class="card-body" style="padding:0;">
      ...
      <div class="po-toolbar">
        ...
        {{-- Jumlah baris per halaman - lihat bankIkatPanjangHalaman() di public/js/bank.js. --}}
      ...
      {{-- #rtBar diisi lewat JS oleh ReportTable.init() - lihat bankInitReportTableSekali(). --}}
      <div id="rtBar"></div>

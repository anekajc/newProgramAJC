              ...
              <table id="tabel" class="table table-bordered table-striped"  >
                ...
                <tr>
                  ...
                  <td class='text-center'>
                    <button class="btn btn-primary btn-sm" type="button" onclick="buttonAdd('{{ $tempOutstanding[$i][0]->nobukti }}')"><i class="bi bi-plus"></i></button>
          ...
          <table id="tabel2" class="table table-bordered table-hover table-striped table-responsive-lg">
            <thead class="text-center bg-primary text-white">
              ...
              <tr>
                ...
                <th style="padding: 4px 12px;"  scope="col">No Cetak</th>
            ...
            <tbody id="tabel2_data" class="text-left">
              ...
              <tr>
                ...
                <td>{!! date("Y/m/d", strtotime($tempPenerimaan[$i][0]->tanggal)) !!}</td>
                 <td>{{ $tempPenerimaan[$i][0]->valas }}</td>
               
                <td class="text-right">{{ number_format($tempPenerimaan[$i][0]->dibayar , 2 ,'.' , ',') }}</td>
                <td class="text-right">{{ number_format($tempPenerimaan[$i][0]->kl , 2 ,'.' , ',') }}</td>
                ...
                <td>{!! $tempPenerimaan[$i][0]->TGLCETAK ? date("Y/m/d", strtotime($tempPenerimaan[$i][0]->TGLCETAK))  : '' !!}</td>
    ...
    success: function(res) {
      ...
      res.tempOutstanding.forEach((item, i) => {
        ...
        <tr>
          ...
          <td>${item[0].valas}</td>
          <td class="text-right">${formatAngkaX(item[0].dibayar)}</td>
          <td class="text-right">${formatAngkaX(item[0].kl)}</td>
      ...
      res.tempPenerimaan.forEach((item, i) => {
          ...
          <tr>
            ...
            <td>${item[0].KODECUSTSUPP}</td>
            <td>${item[0].NamaCustSupp}</td>
            <td>${item[0].NoDPP}</td>
            <td class="text-right">${formatAngkaX(item[0].TotDIBAYAR)}</td>
            <td class="text-right">${formatAngkaX(item[0].TotLB)}</td>
            <td class="text-right">${formatAngkaX(item[0].TotKL)}</td>
            ...
            <td class="text-center">
                <button class="btn btn-warning btn-sm" type="button" title="Detail" onclick="buttonDetail('${item[0].NoBukti}' , 0 , '${item[0].NoDPP}' )">
                  <i class="bi bi-info"></i>
                </button>
                <button class="btn btn-success btn-sm" type="button" title="Koreksi" onclick="buttonKoreksi('${item[0].NoBukti}', '${item[0].NoDPP}')">
                  <i class="bi bi-pen"></i>
                </button>
                ${item[0].IsOtorisasi1 == 1 ? `<button class="btn btn-danger btn-sm" type="button" title="Cancel Authorization" onclick="buttonBatalOtorisasi('${item[0].NoBukti}')">
                  <i class="bi bi-key"></i>
                </button>` : `<button class="btn btn-primary btn-sm" type="button" onclick="buttonDetail('${item[0].NoBukti}' , 1 , '${item[0].NoDPP}' )">
                  <i class="bi bi-key"></i>
                </button>`}

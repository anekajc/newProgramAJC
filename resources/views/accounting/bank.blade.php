...
<div class="container-fluid" >
  ...
  <div class="row" style="margin-top: -30px">
    ...
    <div class="col-6 text-right">
      <button type="button" class="btn btn-primary btn-lg " style="height: 40px; border-radius: 20px; font-size: 0.75rem;font-weight: 600;  " onclick="buttonAdd()"  >+ Bank</button>
    </div>
  </div>
...
<div class="row">
  <nav style="width: 100%;">
    <div class="nav nav-tabs col-12" id="nav-tab" role="tablist" style="border-bottom: 0;">
      <a class="nav-item nav-link active" id="nav-home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="nav-home" aria-selected="true" style="color: #fff; background-color: #007bff; border-radius: 20px; padding: 4px 12px; margin: 0 10px; font-weight: 600; font-size: 0.75rem; text-align: left;">Bank</a>
    </div>
  </nav>
</div>
</div>
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <div class="row" style="margin-top: -10px" class="" >
            ...
            <!-- <div class="col-md-2">
              <div class="form-group">
                <label class="partBBK showhidePart">Bon</label>
              </div>
            </div> -->
            <!-- <div class="col-md-4">
              <div class="form-group input-group"> -->
                ...
                <input type="hidden" class="form-control partBBK showhidePart" id="input_add_bon" placeholder="" disabled>

                <!-- <button class="btn btn-primary btn-sm text-right partBBK showhidePart" id="buttonAddListBon" onclick="buttonAddListBon()"><i class="bi bi-plus"></i></button> -->

              <!-- </div>
            </div> -->
            <!-- <div class="col-md-2">
              <div class="form-group"> -->
                <!-- <label class="partBBK showhidePart">Nilai Bon</label> -->
              <!-- </div>
            </div> -->
            <!-- <div class="col-md-4">
              <div class="form-group"> -->
                <input type="hidden" class="form-control text-right partBBK showhidePart" id="input_add_nilaibon" value="0.00" disabled>
              <!-- </div>
            </div> -->
          </div>
      ...
      <div class="col-md-6">
        <div class="row" style="margin-top: -10px">
          ...
          <div class="col-md-6 text-right">
            <div class="form-group">
              <label class="">Sisa Bon</label>
            </div>
          </div>
          <div class="col-md-3">
            <div class="form-group">
              <input type="text" class="form-control" id="input_add_sisabon" disabled placeholder="" >
            </div>
          </div>

          <div class="col-md-3">
            <div class="form-check">
      <input class="form-check-input" type="checkbox" value="" id="checkBoxKembaliUang">
  ...
  <div class="col-md-12">
    <div class="row">
      <!-- <div class="col-md-11  text-right">
        <div class="form-check">
    <input class="form-check-input" style="margin-top: 6px" type="checkbox" value="" id="checkBoxKembaliUang">
    <label class="form-check-label" for="flexCheckDefault">
    Kembali Uang
    </label>
    </div>
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            <div class="row">
              ...
              <div class="col-md-5">
                <div class="input-group form-group">
                  <input  id="AddAddNamaDevisi" value="Accounting" type="text" class="form-control" disabled>
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="row" style="margin-top: -10px" class="" >
              ...
              <div class="col-md-4">
                <div class="form-group">
                  <input type="text" class="form-control partBBK showhidePart" id="input_detail_bon" placeholder="" disabled>
                </div>
              </div>
              <div class="col-md-2">
                <div class="form-group">
              ...
              <div class="col-md-4">
                <div class="form-group">
                  <input type="number" class="form-control text-right partBBK showhidePart" id="input_detail_nilaibon" value="0.00" disabled>
                </div>
              </div>
            </div>
      ...
      <div class="modal-body">
        ...
        <div class="container-fluid mt-4" >
          ...
          <div class="row">
            ...
            <table id="tabel_add_list_dphuhtbbm_custsupp" class="table table-bordered table-striped" style="overflow:auto; " >
              <thead class="text-center bg-primary text-white">
                <tr>
                  <th style="padding: 4px 12px;" scope="col">KODE</th>
                  <th style="padding: 4px 12px;" scope="col">Nama</th>
          ...
          <!-- </div> -->
            ...
            <div class="row">
              ...
              <table id="tabel_add_list_dphuhtbbm" class="table table-bordered table-striped" style="overflow:auto; " >
                <thead class="text-center bg-primary text-white">
                  <tr>
...
function buttonAddListXAkumulasi () {
  ...
  $('#tabel_add_list_akumulasibiaya').DataTable().destroy();
  $.ajax({
    url: "{!! url('banklistakumulasiinput') !!}",
    type: "get",
    async: false,
    data: {
    },
...
function buttonMinusUMB (index) {
  ...
  let nobukti = $("#input_add_nobukti").val();
  $.ajax({
    url: "{!! url('bankspdeletetemprumjual') !!}",
    type: "post",
    async: false,
    data: {
      _token,
...
function onChangeDPPUMB (index) {
  ...
  $.ajax({
    url: "{!! url('bankspupdatetemprumjual') !!}",
    type: "post",
    async: false,
    data: {
      _token,

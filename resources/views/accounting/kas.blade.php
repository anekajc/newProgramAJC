...
{{-- Gudang-style list view (#page1) plus .dph-tb skin on #page2/#page3 and the entity-picker
     ...
     pager — see public/js/kas.js's renderTabel(), identical conversion to
     accounting/bank.blade.php, this page's Bank twin). report-table.css/tableMaster2.css/
     newmaster.css/pengajuandphtunai.css stay loaded regardless (unlike the reference pages)
     because page2+ (the Add/Detail/Otorisasi forms) and the tabel_add_list_* entity-picker
     modals still depend on them — #page1 just neutralizes the few rules from those files that
     would otherwise leak onto #tabel (see the CSS block below). Kas now has the same Periode
     date-range filter as the DPH pages (#inputDate1/#inputDate2 in the toolbar) - see
     KasController::fetchList()/loadAll() and public/js/kas.js's ikatPeriode(). --}}
...
/* ==========================================================================
   ...
   (dan bonsementara.blade.php) supaya #page1 (list Kas) memakai class & tampilan
   yang persis sama — lihat permintaan "samakan dengan bonsementara/memorialkoreksi"
   (sudah diterapkan lebih dulu di accounting/pengajuandph.blade.php,
   accounting/pengajuandphtunai.blade.php, dan accounting/bank.blade.php).
   ========================================================================== */
